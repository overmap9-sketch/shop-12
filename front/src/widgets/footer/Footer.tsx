        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/catalog" className="text-foreground-muted hover:text-primary transition-colors">
                  All Products
                </Link>
              </li>
              <li>
                <Link to="/categories" className="text-foreground-muted hover:text-primary transition-colors">
                  Categories
                </Link>
              </li>
              <li>
                <Link to="/catalog?new=true" className="text-foreground-muted hover:text-primary transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
                <Link to="/catalog?sale=true" className="text-foreground-muted hover:text-primary transition-colors">
                  Sale Items
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <input
                ...
                className="px-3 py-2 border border-border rounded-md bg-background text-foreground placeholder-foreground-muted focus:outline-none focus:ring-2 focus:ring-ring text-sm"
              />
